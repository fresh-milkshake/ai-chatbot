...
MSG_WELCOME = 'Привет! Я бот работающий с разными ИИ провайдерами. Чтобы узнать, что я умею, напиши /help.\n' \
            'Чтобы начать общение, просто напиши мне что-нибудь, или задай вопрос, например "Что такое GPT-3?"'
MSG_HELP = ('Я - ИИ бот. Я могу помочь с ответами на вопросы, генерировать тексты, исправлять ошибки и многое другое.\n'
...
MSG_ERROR_MODEL_INVALID_REQUEST_ERROR = ('Произошла ошибка при формировании запроса. Похоже, что размер диалога '
                                         ...
                                         'для сброса диалога.')
MSG_ERROR_MODEL_API_ERROR = ('Произошла ошибка при обращении к API. Пожалуйста, попробуйте снова или подождите '
                             'некоторое время.')
